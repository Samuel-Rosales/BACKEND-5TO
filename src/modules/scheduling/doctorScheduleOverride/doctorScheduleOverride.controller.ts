...
import { DoctorScheduleOverrideService } from "./doctorScheduleOverride.service";

const service = new DoctorScheduleOverrideService();

export class DoctorScheduleOverrideController {
